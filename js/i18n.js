...
const i18n = {
  fr: {
    ...
    typeHero: "Héros",
    howTo: "Comment jouer",
    howToText: "L'illustration d'une carte Hearthstone est pixelisée. Tapez un nom de carte pour deviner. À chaque erreur, l'image se dépixelise et un nouvel indice apparaît. Vous avez 5 essais.",
    daily: "Quotidien",
    unlimited: "Illimité",
  ...
  en: {
    ...
    typeHero: "Hero",
    howTo: "How to play",
    howToText: "A Hearthstone card's artwork is pixelated. Type a card name to guess. Each wrong guess de-pixelates the image and reveals a new hint. You have 5 tries.",
    daily: "Daily",
    unlimited: "Unlimited",
